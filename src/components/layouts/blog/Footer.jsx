                ...
                <div id="footer-widget" className="footer-widget-s4 footer-widget-line bg-s1 position-relative">
                    <div className="container">
                        <div className="widget-text text-center">
                            ...
                            <p className="address mg-b2 text-white">Ambala, Haryana, India</p>
                            <p className="email mg-b5 text-white"> rkanika716@gmail.com</p>
                            <p className="phone mg-b53 text-white">+91 9306358597</p>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-12">
                                <div className="copyright lt-sp02">
                                    © kanika, 2022 All rights reserved.
                                </div>
                            </div>
