        ...
        return (
            <div className="col-left">
                ...
                <div className="featured-post position-relative animate-element wow delay5 fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div className="">
                        <Link to={{ pathname: "https://m.facebook.com/100026087977433/" }} target='_blank' className="color-s1"><i className="fa fa-facebook" aria-hidden="true" /></Link>
                        {/* <Link to="#" className="color-s2"><i className="fa fa-twitter" aria-hidden="true" /></Link> */}
                        <Link to={{ pathname: "https://instagram.com/twinkling_lights_04" }} target='_blank' to="#" className="color-s3"><i className="fa fa-instagram" aria-hidden="true" /></Link>
                    </div>
                </div>
            </div>
        );
